...
import AlgoritmRulare.Single.AStar.communResorc.AStarInfo;
import AlgoritmRulare.Single.AStar.communResorc.CommunResurces;
...
public class AStar {
    ...
    public void intialization(TestData td, Graphics g){
    ...
    public void start() {
        ...
        while(currentPoint != null && !hasReachend){
            ...
            if(comRes.getPoinstVisited()[linieCurennta][colanaCurenta] == true){
                ...
                comRes.getG().fillRect(colanaCurenta*comRes.getfPrecis()+1 ,linieCurennta*comRes.getfPrecis()+1 , comRes.getfPrecis()-1 , comRes.getfPrecis()-1);
   ...
   */
    ...
    private void afis(Punct punct) {
        ...
        comRes.getG().fillRect(punctInfo.getPunctCurent().getColoana()*comRes.getfPrecis()+1 , punctInfo.getPunctCurent().getLinie()*comRes.getfPrecis()+1 , comRes.getfPrecis()-1 , comRes.getfPrecis()-1);
