...
import AlgoritmRulare.Paralel.AStar.astarparalelguaranteed.AStarParalelGuaranteed;
import AlgoritmRulare.Paralel.DelataSteppingSingle.deltasteppingparallelfast.DeltaSteppingParallelFast;
import AlgoritmRulare.ParalelAndSngle.DelataSteppingSingle.Dijkstra.dijkstraparalelalg.DijkstraParalelAlg;
import AlgoritmRulare.Single.AStar.astarsingleguaranteed.AStarSingleGuaranteed;
import AlgoritmRulare.Single.DelataSteppingSingle.delatasteppingsingle.DelataSteppingSingle;
import AlgoritmiGenerare.Kruskal.labirintcreateralgskruskal.LabirintCreaterAlgsKruskal;
import AlgoritmiGenerare.Kruskal.labirintcreateralgskruskalmain.LabirintCreaterAlgsKruskalMain;
import AlgoritmiGenerare.LabrintSetPonders.labrintsetpondersmain.LabrintSetPondersMain;
import AlgoritmiGenerare.Prim.labirintcreateralgs.LabirintCreaterAlgsMainPrime;
import FunctiiAjutatoare.FunctiiFisiere;
import FunctiiAjutatoare.FunctiiGrafice;
...
public class F extends JFrame implements ActionListener {
    ...
    public F(String s , boolean[][] Labirint, ArrayList<PunctList> PonderiLabirint ,int marimeLab) {
        ...
        this.PonderiLabirint = PonderiLabirint;
        ...
        */
        ...
        DiagonaleStatus.setText("Algoritmi Paraleleli OFF");
            ...
            try{
                ...
                */
                ...
                if(g.getDiagonealeStatus()){
                    ...
                    FunctiiGrafice.afisareMatriceGenerata(g.getGraphics());

                    g.showPlecareSosire(g.getGraphics(), Plecare, Destinatie);
                    
                    DeltaSteppingParallelFast.start((int)g.getPondere());
                    
                    g.afisDrum(g.getGraphics());
                    
                    int fPrecis = (int)500/this.marimeLab;  
                    g.getGraphics().setColor(Color.red);
                    g.getGraphics().fillRect( Destinatie.getColoana()*fPrecis+1 , Destinatie.getLinie()*fPrecis+1 , fPrecis-1 , fPrecis-1);
                    ...
                    DelataSteppingSingle.start(g.getGraphics());
            ...
            try{
                ...
                */
                 ...
                 if(g.getDiagonealeStatus()){
                    ...
                    DijkstraParalelAlg.paralelStart((int)g.getPondere());
                    ...
                    DijkstraParalelAlg.singleStart(g.getGraphics());
                 }
...
*/
                if(g.getDiagonealeStatus()){
                    ...
                    AStarParalelGuaranteed.start(g.getGraphics(), (int)g.getPondere());
                    //Graphics g, int nrThreads
                    ...
                    AStarSingleGuaranteed.start(g.getGraphics());
         ...
         if(e.getSource()== DiagonaleStatus){
            try{
                if(g.getDiagonealeStatus()){
                    ...
                    DiagonaleStatus.setText("Algoritmi Paraleleli ON");
                }
           }catch(Exception ex){
                System.out.println(ex);
                System.exit(0);
         ...
         if(e.getSource()== Chebyshev){
          ...
          if(e.getSource()== PrimeGenerateMaze){
            try{
               ...
               FunctiiFisiere.initializareFisiere(Plecare,Destinatie,this.marimeLab);
               
               LabirintCreaterAlgsMainPrime.start();
                      
               LabrintSetPondersMain.start();
               
               
               //afisare labirint generat
               FunctiiGrafice.afisareMatriceGenerata(g.getGraphics());
          ...
          if(e.getSource()== KruskalGenerateMaze){
            try{
               ...
               LabirintCreaterAlgsKruskalMain.start();
          ...
          if(e.getSource()== PondereStatus){
            try{
                ...
                if(temp.isEmpty()){
                    this.pondereText.setText("2.0");
                    this.PondereStatus.setText("Numar procese OFF");
                    ...
                    if(this.PondereStatus.getBackground() == Color.RED){
                        ...
                        this.PondereStatus.setText("Numar procese ON");
